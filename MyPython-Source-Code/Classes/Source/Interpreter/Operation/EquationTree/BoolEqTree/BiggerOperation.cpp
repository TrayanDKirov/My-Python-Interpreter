...
const string BiggerOperation::NAME = ">";

BoolVariable* BiggerOperation::compareInt(Variable* leftVar, Variable* rightVar)
{
...
BoolVariable * BiggerOperation::compareFloat(Variable* leftVar, Variable* rightVar)
{
...
BiggerOperation::BiggerOperation(unique_ptr<BasicEqTree> left,
                               unique_ptr<BasicEqTree> right) : BooleanEqTree(std::move(left), std::move(right)) { }

Variable* BiggerOperation::execute(Context& contex)
{
