#include "Interpreter/Operation/EquationTree/BooleanEqTree/LessOrEqualOperation.h"
...
const string LessOrEqualOperation::NAME = "<=";

BoolVariable* LessOrEqualOperation::compareInt(Variable* leftVar, Variable* rightVar)
{
...
BoolVariable * LessOrEqualOperation::compareFloat(Variable* leftVar, Variable* rightVar)
{
...
LessOrEqualOperation::LessOrEqualOperation(unique_ptr<BasicEqTree> left,
                               unique_ptr<BasicEqTree> right) : BooleanEqTree(std::move(left), std::move(right)) { }

Variable* LessOrEqualOperation::execute(Context& contex)
{
